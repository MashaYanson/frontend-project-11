...
const createPost = ({link, title, description},i, readedPosts) => {
...
<button type="button" class="btn btn-outline-primary btn-sm read-button"  data-link="${link}" data-id="${i}" data-bs-toggle="modal" data-bs-target="#modal${i}">
